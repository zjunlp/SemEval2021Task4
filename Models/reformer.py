...
from transformers.modeling_outputs import CausalLMOutput, MaskedLMOutput, QuestionAnsweringModelOutput, SequenceClassifierOutput, MultipleChoiceModelOutput
...
class BertForMultipleChoice(ReformerPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
