...
class DataTrainingArguments:
    ...
    whole_word_mask: bool = field(default=True, metadata={"help": "Whether ot not to use whole word mask."})
...
def get_dataset(
    ...
    def _dataset(file_path, ref_path=None):
        if args.line_by_line:
            return LineByLineTextDataset(tokenizer=tokenizer, file_path=file_path, block_size=args.block_size, args=args)
        else:
            return TextDataset(
                tokenizer=tokenizer,
                file_path=file_path,
